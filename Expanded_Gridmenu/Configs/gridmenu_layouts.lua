local labGrids = {
	...
	-- T2 bot
	armalab = {
		"armack", "armfark", "armfast", "armspy", "armdecom", "armscab",             -- T2 con, butler, sprinter, spy, decoy com, mobile AN
		"armmark", "armaser", "armzeus", "armmav", "armsptk", "armspid",             -- radar bot, jammer bot, welder, gunslinger, recluse, webber
		"armfido", "armsnipe", "armaak", "armfboy", "armamph", "armvader",           -- hound, sharpshooter, AA bot, fatboy, platypus, tumbleweed
	},

	coralab = {
		"corack", "corfast", "corpyro", "corspy", "cordecom", "cormando",            -- T2 con, twitcher, fiend, spy, decoycom, commando
		"corvoyr", "corspec", "corcan", "corhrk", "cortermite", "",                  -- radar bot, jammer bot, sumo, arbiter, termite
		"cormort", "corroach", "coraak", "corsumo", "coramph", "corsktl",            -- sheldon, bedbug, AA bot, mammoth, duck, skuttle
	},
...
local unitGrids = {
	...
	legassistdrone = {
		{
			...
			{ "legeconv", "", "leguwmstore", "legtide"},             -- T1 converter, uw m storage, tidal
	...
	legassistdrone_land = {
		...
		{
			{ "leglht", "legtl", },                          -- LHT, offshore torp launcher
			{ "legrl", "legfrl", },                          -- basic AA, floating AA
			{ "legctl", },                                   -- coastal torp launcher
		},
		{
	...
	corcomlvl3 = {
		...
		},
		{
			...
			{ "corrl", "cormadsam", "corerad", "corfrt", },   -- basic AA, SAM, eradicator, (fl. AA)
			{ "cordl", "corpun", "cortl", "corfrock", },      -- coastal torp launcher, punisher, offshore torp launcher, (fl. SAM)
		},
		{
	...
	corcomlvl5 = {
		{
			...
			{ "cormmkr", "corageo", "cormexp", "coruwmmm", "cortide" },  -- T2 converter, T2 geo, armed moho, floating metalmaker, tidal generator
			{ "coruwadves", "coruwadvms", "", "coruwmme", },             -- hardened energy storage, hardened metal storage, uw metal extractor 
		},
		{
			{ "corvipe", "cordoom", "cortoast", "cormaw", },      -- pop-up gauss, DDM, pop-up artillery, dragon maw
			{ "corflak", "corscreamer", "corhllt", "corenaa", },  -- flak, long-range AA, twin guard, floating flak
    ...
    legcom = {
		{
			{ "legmex", "legsolar", "legwin", },                        -- mex, solar, wind
			{ "legeconv", "", "legfeconv", "legtide", },                    -- T1.5 mex,  floating converter, tidal
			{ "legestor", "legmstor", "leguwestore", "leguwmstore", },  -- e storage, m sotrage, uw e storage, uw m storage
		},
		{
			{ "leglht", "legtl", },                          -- LLT, offshore torp launcher
			{ "legrl", "legfrl", },                          -- basic AA, floating AA
	...
	legcomlvl2 = {
		...
		},
		{
			...
			{ "legrl", "legfrl", "leghades", "leghelios",},           -- basic AA, floating AA, alaris, helios
			{ "legctl", },                                            -- coastal torp launcher
		},
		{
			{ "legrad", "legeyes", "legdrag", },             -- radar, perimeter camera, dragon's teeth
	...
	legcomlvl3 = {
		{
			{ "legmex", "legsolar", "legwin", "legadvsol", "leguwgeo", },     -- mex, solar, wind, adv. solar, (uw geo)
		...
		{
			{ "leggat", "legmg", "leghive", "legdtr", "legkark", "legcen", },  -- decurion, cacophony, hive, riot turret, karkinos, phobos
			{ "legrl", "legfrl", "legrail", "", "", "", },                     -- basic AA, floating AA, lance
			{ "legctl", "legbar", "legtl", "", "", "", },                      -- coastal torp launcher, barrage, offshore torp launcher
		},
		{
	...
	legcomlvl4 = {
		...
		{
			{ "leggat", "legmg", "legvcarry", "legdtr", "legshot", "legstr", },             -- decurion, cacophony, mantis, riot turret, phalanx, hoplite
			{ "legflak", "", "legmed", "leganavalaaturret", "legvflak", "legavantinuke",},  -- T2 AA, medusa, naval T2 AA, vehicle AA, mobile anti-nuke
			{ "legctl", "legbart", "leganavaltorpturret", "", "", "",},                     -- coastal torp launcher, belcher, adv. offshore torp launcher
		},
		{
	...
	legcomlvl5 = {
		{
			{ "legmoho", "legfus", "legwin", "legadvsol", "leguwageo", "legsolar",},   -- adv mex, fusion, wind, adv. solar, solar, uw adv geo, solar
			{ "legadveconv", "leggeo", "", "leganavaleconv", "legtide", "",},   	           -- adv metalmaker, adv geo, adv fl. metalmaker, tidal generator
			{ "legadvestore", "legamstor", "", "leganavalmex", "", "",},                   -- hardened energy storage, hardened metal storage, uw adv mex
		},
		{
			{ "legaheattank", "legmg", "legvcarry", "legdtr", "legshot", "legstr", },         -- prometheus, cacophony, mantis, riot turret, phalanx, strider
			{ "legflak", "", "legmed", "leganavalaaturret", "legvflak", "legavantinuke", },   -- T2 AA, medusa, naval T2 AA, vehicle AA, mobile anti-nuke
			{ "legctl", "leginf", "leganavaltorpturret", "", "", "", },		                  -- coastal torp launcher, inferno, offshore torp launcher
		},
		{
			{ "legavrad", "legeyes", "legforti", "legavjam", },    -- radar bot, perimeter camera, t2 wall, jammer bot
			{ "legfrad", "legfdrag", "legdrag", },                 -- floating radar, sharks teeth, dragons teeth
	...
	legcomlvl6 = {
		{
			{ "legmoho", "legfus", "legwin", "legadvsol", "leguwageo", "",},     -- adv mex, fusion, wind, adv. solar, solar, uw adv. geo
			{ "legadveconv", "leggeo", "", "leganavaleconv", "legtide", "",},   	     -- adv metalmaker, adv geo, T2 fl. conv, tidal generator
			{ "legadvestore", "legamstor", "", "leganavalmex", "", "",},             -- hardened energy storage, hardened metal storage, uw adv mex
		},
		{
			{ "legaheattank", "legmg", "legvcarry", "legdtr", "legshot", "legmrv", },   -- prometheus, cacophony, mantis, riot turret, phalanx, quickshot 
			{ "legflak", "legbastion", "legmed", "leganavalaaturret", "legvflak", "legavantinuke", },   -- T2 AA, bastion,  medusa, naval T2 AA, vehicle AA, mobile anti-nuke
			{ "legctl", "leginf", "leganavaltorpturret", "legkeres", "", "" },		                -- coastal torp launcher, mantis, adv offshore torp launcher, keres
		},
		{
	...
	legcomlvl8 = {
		...
		{
			{ "legavrad", "legeyes", "legforti", "legavjam", "legdeflector", },      -- radar bot, perimeter camera, t2 wall, jammer bot, plasma shield
			{ "legfrad", "legfdrag", "legdrag", },                           -- floating radar, sharks teeth, dragons teeth
			{ "legjuno", "legarad", "legstronghold"},                                -- juno, radar, t2 transport
		},
		{
	...
	legcomlvl9 = {
		...
		},
		{
			{ "legaheattank", "legmg", "legvcarry", "legdtr", "legshot", "legmrv", },                   -- prometheus, cacophony, mantis, riot turret, phalanx, quickshot 
			{ "legflak", "legbastion", "legmed", "leganavalaaturret", "legvflak", "legavantinuke", },   -- T2 AA, bastion, medusa, naval T2 AA, vehicle AA, mobile anti-nuke
			{ "legctl", "leginf", "leganavaltorpturret", "legkeres", "legeshotgunmech", "" },		    -- coastal torp launcher, mantis, adv offshore torp launcher, keres, praetorian
		},
		{
			{ "legavrad", "legeyes", "legforti", "legavjam", "legdeflector",},              -- radar bot, perimeter camera, t2 wall, jammer bot, plasma shield
			{ "legfrad", "legfdrag", "legdrag", },                                  -- floating radar, sharks teeth, dragons teeth
   ...
   legck = {
    ...
    legca = {
		...
		{
			{ "leglht", "legmg", "", "legdtr", },     			-- LLT, machine gun, riot turret
			{ "legrl", "legrhapsis", "leglupara", },            -- basic AA, rhapsis, lupara
			{ "legctl", "legcluster", },                        -- coastal torp launcher, amputator
		},
		{
			{ "legrad", "legeyes", "legdrag", "legjam", },      -- radar, perimeter camera, dragon's teeth, jammer
			{ },                                                -- 
	...
	armcs = {
		...
		{
			{ "armtl", "armfhlt", "", "armclaw", },           -- offshore torp launcher, floating HLT, lightning turret
			{ "armfrt", },                                    -- floating AA
			{ "armdl", "armguard", },              			  -- coastal torp launcher, guardian, 
		},
		{
	...
	corcs = {
		...
		{
			{ "cortl", "corfhlt", "", "cormaw" },             -- offshore torp launcher, floating HLT, flame turret
			{ "corfrt", },                                    -- floating AA
			{ "cordl", "corpun", },                 		  -- coastal torp launcher, punisher
		},
		{
	...
	legnavyconship = {
		...
		{	
			{ "leganavaltorpturret", "legfmg", "", "legdtr", "legfhive", },   -- adv offshore torp launcher, floating HLT, riot turret, floating hive
			{ "legfrl", },                                                    -- floating AA
			{ "legctl", "leginf", "legcluster", },                            -- coastal torp launcher, 			
		},
		{				
	...
	legch = {
		...
		{
			{ "leglab", "legvp", "legap", "legsy", },                        -- bot lab, veh lab, air lab, shipyard
			{ "legnanotc", "legavp", "legnanotcplat", "legadvshipyard", },   -- nano, T2 veh lab, floating nano, adv shipyard
	...
	corcsa = {
		...
		{
			{ "corllt", "corhllt", "corhlt", "cormaw", },     -- LLT, Double LLT, HLT, flame turret
			{ "corrl", "cormadsam", "corerad", "corfrt", },   -- basic AA, SAM, eradicator, floating AA
			{ "cordl", "corpun", "cortl", "corfhlt", },       -- coastal torp launcher, punisher, offshore torp launcher, floating HLT
		},
		{
			{ "corrad", "coreyes", "cordrag", "corjamt", },   -- radar, perimeter camera, dragon's teeth, jammer
	...
	legspcon = {
		...
		},
		{
			...
			{ "legrl", "legrhapsis", "leglupara", "legfrl" },  -- basic AA, rhapsis, t1.5 flak, floating AA
			{ "legctl", "legcluster", "legtl", "legfmg", },    -- coastal torp launcher, amputator, offshore torp launcher, floating machine gun
		},
		{
			{ "legrad", "legeyes", "legdrag", "legjam", },     -- radar, perimeter camera, dragon's teeth, jammer
			{ "legfrad", "legfdrag", },                        -- floating radar, shark's teeth
	...
	legaceb = {
		...
		},
		{
			...
			{ "legctl", "legnavyfrigate", "", "legamph", },          -- coastal torp launcher, argonaut, telchine
		},
		{
		...
		},
		{
			...
			{ "legnanotc", "legnavyconship", },                      -- nano, sea con
			{ },                                      				 --
		}
	},
    ...
    legafcv = {
		...
		{
			{ "leglht", "legmg", "", "legdtr", },     			-- LHT, machine gun, riot turret
			{ "legrl", "legrhapsis", "leglupara", },            -- basic AA, rhapsis, lupara
			{ "legctl", "legcluster", },                        -- coastal torp launcher, amputator
		},
		{
	...
	leganavyengineer = {
		...
		{	
			...
			{ "legnavyscout", "legnavydestro", },                                            -- scout, destroyer
		},
		{
